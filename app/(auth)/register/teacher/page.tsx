      ...
      <div className="relative w-full max-w-2xl">
        ...
        <div className="bg-[#ECECEC] dark:bg-[#1a1a1a] rounded-3xl p-8 shadow-[8px_8px_24px_rgba(0,0,0,0.12),-5px_-5px_16px_rgba(255,255,255,0.8)] dark:shadow-[8px_8px_24px_rgba(0,0,0,0.6)]">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-2xl bg-[#CF291D] flex items-center justify-center shrink-0">
              <span className="text-white text-lg">🎓</span>
            </div>
            <div>
              <h1 className="text-xl font-bold text-[#131313] dark:text-white">Teacher Registration</h1>
        ...
        <p className="text-center text-xs text-[#1D1D1D]/40 dark:text-white/25 mt-5">
          ...
          {" · "}
          <Link href="/register/student" className="text-[#CF291D] font-semibold hover:underline">Register as Student</Link>
        </p>
      </div>
    </div>
  );
